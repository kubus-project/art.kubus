# Asset and Content License Policy

## Default Rule

Unless a file explicitly states otherwise, non-code assets in this repository are **All Rights Reserved**.

This includes, without limitation:
- logos, icons, brand graphics, and visual identity;
...
Brand assets are currently maintained under `assets/images/` in this repository.
They are governed by this policy and are excluded from Apache-2.0 unless a specific file states otherwise.
...
- Reusing logos/brand assets in forks or derivative products.
- Republishing screenshots/demo media in external marketing materials.
- Rehosting or reselling artwork/content assets.
- Using project marks in ways that imply endorsement.
...
Licensing requests: support@kubus.site
