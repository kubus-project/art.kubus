...
import 'file:///G:/WorkingDATA/art.kubus/art.kubus/task_worktrees/app/test/features/map/controller/kubus_map_marker_creation_coordinator_test.dart' as test;
...
void main() {
  ...
  StreamChannel<dynamic> testChannel = serializeSuite(() {
    catchIsolateErrors();
    goldenFileComparator = LocalFileComparator(Uri.parse('file:///G:/WorkingDATA/art.kubus/art.kubus/task_worktrees/app/test/features/map/controller/kubus_map_marker_creation_coordinator_test.dart'));
