...
import 'file:///G:/WorkingDATA/art.kubus/art.kubus/task_worktrees/app/test/services/direct_entry_attribution_test.dart' as test;
...
void main() {
  ...
  StreamChannel<dynamic> testChannel = serializeSuite(() {
    catchIsolateErrors();
    goldenFileComparator = LocalFileComparator(Uri.parse('file:///G:/WorkingDATA/art.kubus/art.kubus/task_worktrees/app/test/services/direct_entry_attribution_test.dart'));
