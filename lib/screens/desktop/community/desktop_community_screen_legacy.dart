...
class DesktopCommunityScreenLegacy extends StatefulWidget {
  const DesktopCommunityScreenLegacy({super.key});

  @override
  State<DesktopCommunityScreenLegacy> createState() => _DesktopCommunityScreenState();
}

class _DesktopCommunityScreenState extends State<DesktopCommunityScreenLegacy>
