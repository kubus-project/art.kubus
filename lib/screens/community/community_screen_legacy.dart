...
class CommunityScreenLegacy extends StatefulWidget {

  const CommunityScreenLegacy({super.key});

  @override
  State<CommunityScreenLegacy> createState() => _CommunityScreenState();
}

class _CommunityScreenState extends State<CommunityScreenLegacy>
