...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get kubusNodeHeroBody => 'kubus Node keeps public cultural records available, serves archive files through the network and can process spatial captures locally. Private source files stay on your hardware unless you choose to publish them.';
  ...
  @override
  String get kubusNodePairBody => 'Create a one-time pairing session in your local kubus Node interface, then paste its QR payload here. The app receives only a scoped local credential.';
  ...
  @override
  String get spatialResultReviewBody => 'Review the private result before publishing. Keeping it private acknowledges the completed compute job without adding it to the public archive.';
  ...
  @override
  String get kubusNodeParticipationDegraded => 'Degraded — existing jobs may finish';

  @override
  String get kubusNodeParticipationLocked => 'Locked — archive participation required';
