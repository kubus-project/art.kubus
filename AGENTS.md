...
## Current product/design programme (read before UI, map, SEO, or public-entry work)

The active programme is documented in:

- `CLAUDE.md` — current agent entrypoint and reference branches.
- `docs/PRODUCT_UX_SEO_PROGRAM.md` — ordered programme and agent work packages.
...
family direction: Sofia Sans/technical mono, flat structural surfaces,
